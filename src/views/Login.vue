<template>
  <div id="login" class="demo-input-suffix loginViewOuterContainer">
    <canvas v-show="showRainCssCanvas" id="canvas" style="position: absolute; height: 100%; width:100%;"></canvas>
    <div class="loginViewInnerContainer">
      <el-row type="flex" class="row-bg" justify="center">
        <div style="padding: 20px 0">
          <span style="font-size: 40px">Welcome To My Website(Test)</span>
        </div>
      </el-row>
...
//   let curWinHeight = window.innerHeight
...
export default {
  ...
  methods: {
    ...
    loginUp () {
      this.showRainCssCanvas = !this.showRainCssCanvas
    }
  }
}
</script>
...
.loginViewInnerContainer {
  display: flex;
  flex-direction: column;
  align-items: center;
}

.loginViewInnerContainer > div {
  width: 320px;
  padding-top: 20px;
}

.loginViewInnerContainer > div:first-child {
  width: 100%;
  padding-top: 0;
}
...
/*#login {*/
/*  cursor: url('/Umbrella.jpg'), pointer;*/
/*}*/
</style>
